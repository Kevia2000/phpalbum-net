...
if(check_version($pa_db_version[0]["version"],"0.4.1.15")){
	echo "applying changes for 0.4.1.15 version<br>";
	db_drop_table("color_map");
	db_create_table("color_map",Array(
					"theme"=>"",
					"id"=>"",
					"name"=>"my_colors",
					"colors"=>Array()));
	db_alter_table_add_column("theme","custom_parameters",Array());
	db_alter_table_add_column("theme","theme_path","");
	db_delete("theme");
    ...
    db_insert("languages",Array("name"=>"NL_ISO8859_1","desc"=>"Dutch ISO-8859-1","character_set"=>"ISO-8859-1","include_file"=>"nl_utf8.php","translate_file"=>"translate_ln_iso88591.php"));
    ...
    db_alter_table_add_column("theme","slimbox_enabled","false");
    
    db_alter_table_add_column("setup","index_keywords","true");
	db_alter_table_add_column("setup","index_short_desc","true");
	db_alter_table_add_column("setup","index_long_desc","false");
	db_alter_table_add_column("setup","index_filenames","true");
	db_alter_table_add_column("setup","index_stopwords","I,a,about,an,are,as,at,be,by,com,de,en,for,from,how,in,is,it,la,of,on,or,that,the,this,to,was,what,when,where,who,will,with,und,the,www");
