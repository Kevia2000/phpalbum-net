<table cellspacing="0" id="ECARD">
<?php    if($sending_ecard){ ?>
			<!-- dialog for adding comment-->
			<tr><td  colspan="2" align="left">
				 <form method="post" action="<?php echo $post_ecard_link?>">
				 <table >
				  <tr><td nowrap align="right"><?php p("ID_SENDER_NAME");?>&nbsp;<input name="p_sender_name" size="25" value="<?php echo $comment_name?>"/>&nbsp;&nbsp;</td><td nowrap align="right">
					<?php p("ID_SENDER_EMAIL");?>&nbsp;<input name="p_sender_email" size="30" value="<?php echo $comment_email?>"/><td></tr>
