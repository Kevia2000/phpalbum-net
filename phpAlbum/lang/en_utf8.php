...
function pa_get_frontend_lang(){
	...
	$pa_texts=Array(
		...
		"ID_REQUEST_PASSWD"=>"Request new password"
	);
	return $pa_texts;
}
...
function pa_get_backend_lang(){
	$pa_texts=Array(
		...
		"ID_SETUP_DESC_MAIN"=>"This is the main setup page. Here you can setup main settings, thumbnails settings and some theme settings. This page is called after installing automatically and you have to setup this before using phpAlbum.",
		"ID_SETUP_DESC_THUMBNAILS"=>"On this page you can setup size and quality of thumbnails and resized photos. Each group of Thumbnail settings represent one quality setting. User can then change one of enabled quality settings. Default quality setting is taken for first time visitors. You can add new quality settings or delete them. It is not possible to delete last setting, so one enabled and default is still there.",
		"ID_SETUP_DESC_THEMES"=>"On this page you can change all things regarding the visual appereance of your album. You can choose style of thumbnails either flowing or raster. You can further choose the theme you want to use and edit your color maps",
		"ID_SETUP_DESC_LOGS"=>"In this setup page you can enable logging of hits on your gallery, you can also change log file name, so nobody can read this and for example make some exclude-strings so you can ignore some host names.",
		...
		"ID_SETUP_DESC_ADMIN"=>"On this page you can upload new photos and administer the photos directory, for this it is needed that you set up the ftp-server and Photos directory on ftp-server variables in main-setup. If you installed phpAlbum.net with wizard, this should be already set up and be correct. If you moved phpAlbum main directory, you must also move the directory setting.",
		...
		"ID_SETUP_DESC_ECARD"=>"On this page you can change settings about e-cards. E-cards are E-Mail post cards, users of your album can send e-cards with your pictures (only linked in email) to other people.",
		...
		"ID_SETUP_ERRORLOG_DESC"=>"Here you can find error messages. This is usable if you don't know why for example something doesn't function. You can use it for reporting bugs or for getting help from phpAlbum support.",
		"ID_SETUP_TEXTS_DESC"=>"On this page you can create your own language translation. Please check main setup for already available languages. There you can change your preferable language and here you can make some fine tuning of it or just translate it to some fully other language. If you feel you made some perfect translation for your language you can send us your translation file and we can incorporate your translation to the standard (file is in your data directory named translation.dat).",
		"ID_SETUP_TEXTS_GUIDE"=>"Translation Guide: You can translate only the phrases you want to change. This will be then used instead of the original language element.</br>You can se here 3 fields for each language element. Its ID in grey color, its original language text in green color and an input field for your translation. This is then yellow if not translated and white if already translated. <b> For translating full language you want to contribute translate also the fields where the translation is the same as original</b>. Pleas be careful to use %s where it was originally and also som html tags like &lt;b&gt; ...",
		...
		"ID_SETUP_MY_ACCOUNT_DESC"=>"Here you can edit your user data, the name, email, home page, change your password.",
		...
		"ID_SETUP_NEW_DIR_INDIC_DESC"=>"How long should be with other type of directory icon indicated, that there are new files in gallery. Type number in Hours",
		...
		"ID_SETUP_QUALITY_THMB_DESC"=>"Please type here the largest size of thumbnails (i.e. 100 or 150). As a second parameter type quality of jpeg compression (normal values from 40 to 90). Quality is used only for JPG files not for PNG or GIF. You can also check <b>Square Thumbnails</b> getting then all thumbnails the same size.",
		"ID_SETUP_QUALITY_PHOTO"=>"Photo size / quality",
		"ID_SETUP_QUALITY_PHOTO_DESC"=>"Please type here the largest size of resized photo (i.e. 100 or 150). As a second parameter type quality of jpeg compression (normal values from 40 to 90). Quality is used only for JPG files not for PNG or GIF. <b> Use for size = 0 (zero) if no resizing at all should be done</b>",
		...
		"ID_SETUP_RESIZE_TO_FIT_DESC"=>"Select how should be photos resized, concerning both widht and height to fit the size or only widht or height. You can so setup that all resized photos has same height or width or that they fit into square size x size.",
		...
		"ID_SETUP_THEME_DESC"=>"Please choos one of the aviable themes. For creating your own theme just copy for example Borders directory to some other and this will automatically available for select here.",
		...
		"ID_SETUP_LOGS_EXCLUDE_DESC"=>"Enter strings delimited with ; (semiclon). You can so exclude from logging some hosts. For example if you know that all your access will be logged as from your_internet_provider.com you just type here your_internet_provider",
		
		"ID_SETUP_CACHE_THUMBNAILS"=>"Cache thumbnails",
		"ID_SETUP_CACHE_RESIZED_PHOTOS"=>"Cache resized photos",
		"ID_SETUP_CACHE_THUMBNAILS_DESC"=>"This checkbox enables caching of generated thumbnails. This is highly recommended, because it is then much faster if the program loads the stored thumbnails instead of generating it for each request.",
		"ID_SETUP_CACHE_RESIZED_PHOTOS_DESC"=>"This checkbox enables caching of resized photos. This is also very helpful for speeding up your album, but it takes also quite much space from your web space. So be careful for enabling this.",
		"ID_SETUP_LOGIN"=>"Login",
		"ID_USERNAME"=>"Username",
		"ID_SETUP_ACT_DIR"=>"Actual directory:",
		"ID_SETUP_ACT_DIR_DESC"=>"You can change here manually the actual folder on ftp server. Easier is to user the directory links in list of files.",
		...
		"ID_SETUP_EMAIL"=>"Your E-Mail address:",
		"ID_SETUP_EMAIL_DESC"=>"Please enter here your email address, this will not be published.",
		...
		"ID_THANKS_FOR_REGISTER"=>"Thank you for registering on this site.",
		"ID_SETUP_DELETE_ERROROLOG"=>"Delete Errorlog",
		"ID_SETUP_ADD_GROUP"=>"Add new user group",
		"ID_SETUP_NEW_GROUP_NAME"=>"Name of new group:",
		"ID_SETUP_ADD_GROUP_DESC"=>"Please enter the name of new group and click the button. This will create a new group. You can then assign it to the users and galleries.",
		...
		"ID_SETUP_GALLERY_DESC"=>"Please choose the gallery you want to setup. If you do not find what you expected, try to scan directories with the following link:",
		"ID_SETUP_ALIAS"=>"Alias name:",
		"ID_SETUP_ALIAS_DESC"=>"Please enter alias name of the directory which should be displayed instead of directory name",
		...
		"ID_SETUP_GALLERY_PARAMS_DESC"=>"Select parameters you would like to see with pictures. For defining more parameters please go to Photo Parameters section.",
		...
		"ID_SETUP_ADD_THMB_HEIGHT_WIDTH_DESC"=>"Please increase this value if you are using more lines for directory or thumbnail description. This will make then more place under thumbnails. This is used only in flowing style where more lines of description can cause layout problems.",
		...
		"ID_SETUP_THEME_NEWEST_COUNT_DESC"=>"Enter the count of the newest pictuers which should be displayed on the front page",
		...
		"ID_MSG_USERNAME_MANDATORY"=>"Username is mandatory field!",
		...
		"ID_SETUP_DESC_SEARCH"=>"In this setup section you can set up behaviour of the full text search engine. After saving of this form it can take some time until new full text index is computed.",
		"ID_SETUP_INDEX_KEYWORDS"=>"Index Keywords",
		"ID_SETUP_INDEX_KEYWORDS_DESC"=>"Check this checkbox if you want that the fulltext indexes keywords (tags) of the photos",
		"ID_SETUP_INDEX_SHORT_DESC"=>"Index short descriptions",
		"ID_SETUP_INDEX_SHORT_DESC_DESC"=>"Check this checkbox if you want that the fulltext indexes short descriptions of the photos",
		"ID_SETUP_INDEX_LONG_DESC"=>"Index long descriptions",
